...
You have 3 button that should load [the goods](https://ValentynaBahyrly.github.io/react_dynamic-list-of-goods/goods.json) and show them on the page using the `GoodsList`.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ValentynaBahyrly.github.io/react_dynamic-list-of-goods/) and add it to the PR description.
